    ...
    <div className="relative w-full bg-gray-100 rounded-lg overflow-hidden shadow-lg">
      ...
      {!isActive ? (
        ...
        <>
          ...
          {/* Live Indicator */}
          <div className="absolute top-4 right-4 flex items-center gap-2 bg-red-600 text-white px-3 py-1 rounded-md text-sm font-medium">
            <span className="w-2 h-2 bg-white rounded-full animate-pulse"></span>
            LIVE
          </div>

          {/* Backend Connection Indicator */}
          <div className="absolute top-4 left-4 bg-black bg-opacity-50 text-white px-3 py-1 rounded-md text-xs">
